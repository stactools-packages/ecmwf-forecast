...
def create_collection(
    ...
    with open("constant_kerchunk.json") as jsonfile:
        ...
        "data": pystac.extensions.item_assets.AssetDefinition(
            {
                ...
                "roles": ["data"],
                "extra_fields": {"kerchunk:indices": kerchunk_indices}, 
    ...
    for p in parts:
        ...
        item.add_asset(
            ...
            pystac.Asset(
                ...
                roles=roles,
                extra_fields={"ecmwf:step": p.step, "kerchunk:indices:unique": kerchunk_indices} if not split_by_step else {"kerchunk:indices": kerchunk_indices},
            ),
        )
